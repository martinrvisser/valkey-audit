...
%cmake \
    ...
    -DVALKEY_INCLUDE_DIR=/usr/include \
    -DBUILD_TESTING=OFF
%cmake_build
...
%changelog
* Mon May 25 2026 Martin Visser <mvisser@hotmail.com> - 1.0.0-1
- Bump to 1.0.0
- Updated for Valkey 9.1 compatibility
